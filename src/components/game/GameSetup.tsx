  ...
  return (
    <Card className="max-w-md mx-auto shadow-lg border-blue-100">
      <CardHeader className="text-center">
        ...
        <CardTitle className="text-3xl text-slate-800">Klaar voor de start?</CardTitle>
      ...
      <CardContent className="flex flex-col items-center gap-6">
        <div className="flex items-center gap-4 bg-slate-50 p-4 rounded-xl">
          ...
          <span className="text-3xl font-bold w-8 text-center text-slate-800">{num}</span>
          <Button 
            variant="outline" 
            size="icon" 
        ...
        <Button 
          size="lg" 
          className="w-full bg-blue-600 hover:bg-blue-700 text-white py-6 text-lg rounded-xl transition-all shadow-md hover:shadow-blue-600/30 font-bold"
          onClick={() => onStart(num)}
        >
          Start het Spel!
        </Button>
